...
I build full-stack web applications end-to-end — from database schema to deployed UI — and work on applied ML, from classical NLP models to LLM post-training and evaluation. I care about shipping things that are tested, documented, and actually deployed, not just prototyped.
